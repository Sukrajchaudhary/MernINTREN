        ...
        >
          ...
          <div className="p-4 absolute bottom-0 left-0 z-20">
            ...
            <div className="flex mt-3">
              <p className="h-10 w-10 rounded-full border flex justify-center items-center mr-2 object-cover">
                {/* {Blog?.owner[0]?.username.charAt(0).toUpperCase()} */}
              </p>
              <div>
                <p className="font-bold text-green-200 text-sm">
                  {" "}
                  {/* {Blog?.owner[0]?.username}{" "} */}
                </p>
